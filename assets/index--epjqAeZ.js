import{b as w4,d as H,g as t4,e as C4,s as v,B as b4,_ as w,r as H4,f as d,h as i4,u as x4,i as V4,k as a4,l as V,n as r4,o as G,p as E4,q as y4,t as v4,a as e,m as k4,v as F,w as I4,x as z4,y as J,z as b,A as l4,C as Y,D as n4,E as o4,F as S4,G as k,H as I,I as s4,j as n,J as x,T as y,K as g,L as d4,M as c4,O as Q,P as O,Q as A,R as p4,S as j,U as A4,V as N4,c as P4}from"./index-CsP3sCZy.js";import{E as $4}from"./easeing-rj1l849s.js";const L4=w4(H.jsx("path",{d:"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 0 0-1.41 0l-1.83 1.83 3.75 3.75z"}),"Edit");function F4(t){return t4("PrivateSwitchBase",t)}C4("PrivateSwitchBase",["root","checked","disabled","input","edgeStart","edgeEnd"]);const Y4=["autoFocus","checked","checkedIcon","className","defaultChecked","disabled","disableFocusRipple","edge","icon","id","inputProps","inputRef","name","onBlur","onChange","onFocus","readOnly","required","tabIndex","type","value"],O4=t=>{const{classes:C,checked:i,disabled:a,edge:r}=t,c={root:["root",i&&"checked",a&&"disabled",r&&`edge${V(r)}`],input:["input"]};return r4(c,F4,C)},j4=v(b4)(({ownerState:t})=>w({padding:9,borderRadius:"50%"},t.edge==="start"&&{marginLeft:t.size==="small"?-3:-12},t.edge==="end"&&{marginRight:t.size==="small"?-3:-12})),R4=v("input",{shouldForwardProp:H4})({cursor:"inherit",position:"absolute",opacity:0,width:"100%",height:"100%",top:0,left:0,margin:0,padding:0,zIndex:1}),B4=d.forwardRef(function(C,i){const{autoFocus:a,checked:r,checkedIcon:c,className:f,defaultChecked:L,disabled:m,disableFocusRipple:l=!1,edge:p=!1,icon:u,id:o,inputProps:R,inputRef:z,name:B,onBlur:N,onChange:P,onFocus:$,readOnly:q,required:T=!1,tabIndex:U,type:E,value:s}=C,_=i4(C,Y4),[W,m4]=x4({controlled:r,default:!!L,name:"SwitchBase",state:"checked"}),Z=V4(),u4=M=>{$&&$(M),Z&&Z.onFocus&&Z.onFocus(M)},M4=M=>{N&&N(M),Z&&Z.onBlur&&Z.onBlur(M)},g4=M=>{if(M.nativeEvent.defaultPrevented)return;const X=M.target.checked;m4(X),P&&P(M,X)};let S=m;Z&&typeof S>"u"&&(S=Z.disabled);const Z4=E==="checkbox"||E==="radio",D=w({},C,{checked:W,disabled:S,disableFocusRipple:l,edge:p}),K=O4(D);return H.jsxs(j4,w({component:"span",className:a4(K.root,f),centerRipple:!0,focusRipple:!l,disabled:S,tabIndex:null,role:void 0,onFocus:u4,onBlur:M4,ownerState:D,ref:i},_,{children:[H.jsx(R4,w({autoFocus:a,checked:r,defaultChecked:L,className:K.input,disabled:S,id:Z4?o:void 0,name:B,onChange:g4,readOnly:q,ref:z,required:T,ownerState:D,tabIndex:U,type:E},E==="checkbox"&&s===void 0?{}:{value:s},R)),W?c:u]}))});function q4(t){return t4("MuiSwitch",t)}const h=C4("MuiSwitch",["root","edgeStart","edgeEnd","switchBase","colorPrimary","colorSecondary","sizeSmall","sizeMedium","checked","disabled","input","thumb","track"]),T4=["className","color","edge","size","sx"],U4=t=>{const{classes:C,edge:i,size:a,color:r,checked:c,disabled:f}=t,L={root:["root",i&&`edge${V(i)}`,`size${V(a)}`],switchBase:["switchBase",`color${V(r)}`,c&&"checked",f&&"disabled"],thumb:["thumb"],track:["track"],input:["input"]},m=r4(L,q4,C);return w({},C,m)},_4=v("span",{name:"MuiSwitch",slot:"Root",overridesResolver:(t,C)=>{const{ownerState:i}=t;return[C.root,i.edge&&C[`edge${V(i.edge)}`],C[`size${V(i.size)}`]]}})({display:"inline-flex",width:34+12*2,height:14+12*2,overflow:"hidden",padding:12,boxSizing:"border-box",position:"relative",flexShrink:0,zIndex:0,verticalAlign:"middle","@media print":{colorAdjust:"exact"},variants:[{props:{edge:"start"},style:{marginLeft:-8}},{props:{edge:"end"},style:{marginRight:-8}},{props:{size:"small"},style:{width:40,height:24,padding:7,[`& .${h.thumb}`]:{width:16,height:16},[`& .${h.switchBase}`]:{padding:4,[`&.${h.checked}`]:{transform:"translateX(16px)"}}}}]}),D4=v(B4,{name:"MuiSwitch",slot:"SwitchBase",overridesResolver:(t,C)=>{const{ownerState:i}=t;return[C.switchBase,{[`& .${h.input}`]:C.input},i.color!=="default"&&C[`color${V(i.color)}`]]}})(({theme:t})=>({position:"absolute",top:0,left:0,zIndex:1,color:t.vars?t.vars.palette.Switch.defaultColor:`${t.palette.mode==="light"?t.palette.common.white:t.palette.grey[300]}`,transition:t.transitions.create(["left","transform"],{duration:t.transitions.duration.shortest}),[`&.${h.checked}`]:{transform:"translateX(20px)"},[`&.${h.disabled}`]:{color:t.vars?t.vars.palette.Switch.defaultDisabledColor:`${t.palette.mode==="light"?t.palette.grey[100]:t.palette.grey[600]}`},[`&.${h.checked} + .${h.track}`]:{opacity:.5},[`&.${h.disabled} + .${h.track}`]:{opacity:t.vars?t.vars.opacity.switchTrackDisabled:`${t.palette.mode==="light"?.12:.2}`},[`& .${h.input}`]:{left:"-100%",width:"300%"}}),({theme:t})=>({"&:hover":{backgroundColor:t.vars?`rgba(${t.vars.palette.action.activeChannel} / ${t.vars.palette.action.hoverOpacity})`:G(t.palette.action.active,t.palette.action.hoverOpacity),"@media (hover: none)":{backgroundColor:"transparent"}},variants:[...Object.entries(t.palette).filter(([,C])=>C.main&&C.light).map(([C])=>({props:{color:C},style:{[`&.${h.checked}`]:{color:(t.vars||t).palette[C].main,"&:hover":{backgroundColor:t.vars?`rgba(${t.vars.palette[C].mainChannel} / ${t.vars.palette.action.hoverOpacity})`:G(t.palette[C].main,t.palette.action.hoverOpacity),"@media (hover: none)":{backgroundColor:"transparent"}},[`&.${h.disabled}`]:{color:t.vars?t.vars.palette.Switch[`${C}DisabledColor`]:`${t.palette.mode==="light"?E4(t.palette[C].main,.62):y4(t.palette[C].main,.55)}`}},[`&.${h.checked} + .${h.track}`]:{backgroundColor:(t.vars||t).palette[C].main}}}))]})),Q4=v("span",{name:"MuiSwitch",slot:"Track",overridesResolver:(t,C)=>C.track})(({theme:t})=>({height:"100%",width:"100%",borderRadius:14/2,zIndex:-1,transition:t.transitions.create(["opacity","background-color"],{duration:t.transitions.duration.shortest}),backgroundColor:t.vars?t.vars.palette.common.onBackground:`${t.palette.mode==="light"?t.palette.common.black:t.palette.common.white}`,opacity:t.vars?t.vars.opacity.switchTrack:`${t.palette.mode==="light"?.38:.3}`})),W4=v("span",{name:"MuiSwitch",slot:"Thumb",overridesResolver:(t,C)=>C.thumb})(({theme:t})=>({boxShadow:(t.vars||t).shadows[1],backgroundColor:"currentColor",width:20,height:20,borderRadius:"50%"})),K4=d.forwardRef(function(C,i){const a=v4({props:C,name:"MuiSwitch"}),{className:r,color:c="primary",edge:f=!1,size:L="medium",sx:m}=a,l=i4(a,T4),p=w({},a,{color:c,edge:f,size:L}),u=U4(p),o=H.jsx(W4,{className:u.thumb,ownerState:p});return H.jsxs(_4,{className:a4(u.root,r),sx:m,ownerState:p,children:[H.jsx(D4,w({type:"checkbox",icon:o,checkedIcon:o,ref:i,ownerState:p},l,{classes:w({},u,{root:u.switchBase})})),H.jsx(Q4,{className:u.track,ownerState:p})]})}),X4={init:{opacity:0,scale:.95},ani:{opacity:1,scale:1},exit:{opacity:0,scale:1.05}},h4=({children:t,className:C,duration:i=.8})=>e(k4.div,{className:C,variants:X4,initial:"init",animate:"ani",exit:"exit",transition:{duration:i,ease:$4.EASE_IN_OUT_EXPO},children:t}),G4=async()=>{const t=F(b,"HISTORY"),C=I4(t,z4("endYear","desc")),i=await J(C);return await Promise.all(i.docs.map(async r=>{const c=F(b,"HISTORY",r.id,"projects"),f=await J(c);return{id:r.id,...r.data(),projects:f.docs.map(L=>({id:L.id,...L.data()}))}}))},J4=async t=>{const C=F(b,"HISTORY");return await l4(C,t)},e2=async t=>{if(t.id===void 0)throw new Error("id is required");const C=Y(b,"HISTORY",t.id);return await n4(C,{name:t.name,startYear:t.startYear,endYear:t.endYear,inOffice:t.inOffice})},t2=async t=>{if(t.id===void 0)throw new Error("id is required");const C=Y(b,"HISTORY",t.id);return await o4(C)},C2=async t=>{const C=F(b,`HISTORY/${t.compId}/projects`);return await l4(C,t)},i2=async t=>{if(t.id===void 0)throw new Error("id is required");const C=Y(b,`HISTORY/${t.compId}/projects`,t.id);return await n4(C,{name:t.name,date:t.date,part:t.part})},a2=async t=>{if(t.id===void 0)throw new Error("id is required");const C=Y(b,`HISTORY/${t.compId}/projects`,t.id);return await o4(C)},r2=()=>S4({queryKey:["compList"],queryFn:async()=>await G4()}),l2=()=>{const t=k();return I({mutationFn:async({docData:C})=>{const i=await J4(C);return t.invalidateQueries({queryKey:["compList"]}),i}})},n2=()=>{const t=k();return I({mutationFn:async({docData:C})=>{const i=await e2(C);return t.invalidateQueries({queryKey:["compList"]}),i}})},o2=()=>{const t=k();return I({mutationFn:async({docData:C})=>{const i=await t2(C);return t.invalidateQueries({queryKey:["compList"]}),i}})},s2=()=>{const t=k();return I({mutationFn:async({docData:C})=>{const i=await C2(C);return t.invalidateQueries({queryKey:["compList"]}),i}})},d2=()=>{const t=k();return I({mutationFn:async({docData:C})=>{const i=await i2(C);return t.invalidateQueries({queryKey:["compList"]}),i}})},c2=()=>{const t=k();return I({mutationFn:async({docData:C})=>{const i=await a2(C);return t.invalidateQueries({queryKey:["compList"]}),i}})},f4=({setOpen:t,isAddMode:C=!1,addModeCompId:i,projectData:a})=>{const{mutateAsync:r,isPending:c}=s2(),{mutateAsync:f,isPending:L}=d2(),{control:m,handleSubmit:l,formState:{errors:p}}=s4({defaultValues:{name:a?.name||"",date:a?.date||"",part:a?.part||""}}),u=d.useCallback(async o=>{C?await r({docData:{compId:i||"",name:o.name,date:o.date,part:o.part}}):await f({docData:{compId:a?.compId||"",id:a?.id,name:o.name,date:o.date,part:o.part}}),t(!1)},[]);return e(h4,{className:"editPrjItem",duration:.24,children:n("form",{onSubmit:l(u),className:"wrap",children:[e(x,{name:"name",control:m,rules:{required:"프로젝트명이 없음"},render:({field:o})=>e(y,{...o,size:"small",error:!!p.name,InputProps:{style:{backgroundColor:"#fff",color:"#000"}}})}),e(x,{name:"date",control:m,rules:{required:"프로젝트 시작일이 없음"},render:({field:o})=>e(y,{...o,size:"small",error:!!p.date,InputProps:{style:{width:"90px",backgroundColor:"#fff",color:"#000"}}})}),e(x,{name:"part",control:m,rules:{required:"작업 파트가 없음"},render:({field:o})=>e(y,{...o,size:"small",error:!!p.part,InputProps:{style:{backgroundColor:"#fff",color:"#000"}}})}),e(g,{type:"submit",variant:"contained",size:"small",sx:{backgroundColor:"#000",color:"#fff"},children:e(d4,{})}),e(g,{variant:"contained",size:"small",onClick:()=>t(!1),children:e(c4,{})}),L||c&&e(Q,{size:"30px"})]})},"compTransition")},p2=({projectData:t})=>{const{user:C}=O(),i=d.useMemo(()=>C?.role?.toUpperCase()==="ADMIN",[C]),[a,r]=d.useState(!1),{mutateAsync:c}=c2(),f=async()=>{await c({docData:t})};return t?n(A,{children:[n("div",{className:"prjItem",children:[e("strong",{className:"prjName",children:t?.name}),e("span",{className:"date",children:t?.date||"-"}),t?.part&&e("div",{className:"part",children:t?.part?.split(",").map(L=>e("span",{children:L},L))}),i&&n(A,{children:[e(g,{className:"btnEdit",variant:"contained",size:"small",onClick:()=>r(!0),title:"프로젝트 수정",children:e(L4,{})}),e(g,{className:"btnDelete",variant:"contained",size:"small",color:"error",onClick:f,title:"프로젝트 삭제",children:e(p4,{})})]})]}),e(j,{children:a&&e(f4,{setOpen:r,projectData:t})})]}):null},L2=({compId:t})=>{const[C,i]=d.useState(!1);return n(A,{children:[e(g,{variant:"contained",fullWidth:!0,size:"small",onClick:()=>i(!0),title:"프로젝트 추가",sx:{minWidth:0,padding:"0.2rem",borderRadius:"10rem",backgroundColor:"#ffa700",color:"#000","&:hover":{backgroundColor:"#000",color:"#ffa700"}},children:e(A4,{})}),e(j,{children:C&&e(f4,{setOpen:i,isAddMode:!0,addModeCompId:t})})]})},h2=t=>t.projects?.sort((C,i)=>{if(!C.date||!i.date)return 0;const a=new Date(parseInt(C.date.split(".")[0],10),parseInt(C.date.split(".")[1],10)-1||0),r=new Date(parseInt(i.date.split(".")[0],10),parseInt(i.date.split(".")[1],10)-1||0);return a>r?-1:1}),f2=({projectDatas:t})=>{const{user:C}=O(),i=d.useMemo(()=>C?.role?.toUpperCase()==="ADMIN",[C]),a=d.useMemo(()=>h2(t),[t]);return a?n("ul",{className:"prjList",children:[i&&e("li",{children:e(L2,{compId:t.id||""})},"projectAdd"),a?.map(r=>e("li",{children:e(p2,{projectData:{...r,compId:t.id||""}})},r.id))]}):null},e4=({compData:t})=>{const{user:C}=O(),[i,a]=d.useState(!1),{mutateAsync:r,isPending:c}=l2(),{mutateAsync:f,isPending:L}=n2(),{mutateAsync:m}=o2(),l=t||{inOffice:!1,startYear:"",endYear:"",name:"",projects:[]},p=d.useMemo(()=>l.id===void 0,[l.id]),u=d.useMemo(()=>C?.role?.toUpperCase()==="ADMIN",[C]),{control:o,handleSubmit:R,formState:{errors:z},reset:B}=s4({defaultValues:{inOffice:l.inOffice,startYear:l.startYear,endYear:l.endYear,name:l.name}}),N=d.useCallback(()=>{a(!0)},[]);d.useEffect(()=>{i||B()},[i]);const P=d.useCallback(async s=>{p?await r({docData:{name:s.name,startYear:s.startYear,endYear:s.endYear,inOffice:s.inOffice}}):await f({docData:{id:l.id,name:s.name,startYear:s.startYear,endYear:s.endYear,inOffice:s.inOffice}}),a(!1)},[]),$=()=>{p&&!i&&a(!0)},q=async()=>{await m({docData:{id:l.id,name:l.name,startYear:l.startYear,endYear:l.endYear,inOffice:l.inOffice}})},T=d.useMemo(()=>`item ${p?"isAddMode":""} ${i?"isEditMode":""}`,[p,i]),U=d.useMemo(()=>`title ${i?"isBlur":""}`,[i]),E=d.useMemo(()=>l.inOffice?"Present":l.endYear,[l]);return n("div",{className:T,onClick:()=>$(),children:[!p&&n(A,{children:[n("div",{className:U,children:[n("span",{className:"yearFirst",children:[l.startYear," -"]}),e("strong",{className:"yearLast",children:E}),l.inOffice&&e("span",{className:"curComp",children:"재직중"})]}),n("div",{className:`compPrjList ${i?"isBlur":""}`,children:[n("div",{className:"comp",children:[l.name,u&&n("div",{className:"btns",children:[e(g,{variant:"contained",color:"primary",size:"small",title:"수정",onClick:N,children:e(L4,{})}),e(g,{variant:"contained",color:"error",size:"small",title:"삭제",onClick:q,children:e(p4,{})})]})]}),l&&e(f2,{projectDatas:l})]})]}),e(j,{children:i&&e(h4,{className:"editItem",duration:.24,children:n("form",{onSubmit:R(P),className:"wrap",children:[e(x,{name:"inOffice",control:o,render:({field:s})=>e(K4,{...s,checked:s.value,onChange:_=>s.onChange(_.target.checked)})}),e(x,{name:"startYear",control:o,rules:{required:"시작년도에 값이 없음"},render:({field:s})=>e(y,{...s,type:"number",size:"small",error:!!z.startYear,InputProps:{style:{width:"90px",backgroundColor:"#fff",color:"#000"}}})}),e("span",{children:"~"}),e(x,{name:"endYear",control:o,rules:{required:"종료년도에 값이 없음"},render:({field:s})=>e(y,{...s,type:"number",size:"small",error:!!z.endYear,InputProps:{style:{width:"90px",backgroundColor:"#fff",color:"#000"}}})}),e(x,{name:"name",control:o,rules:{required:"회사이름에 값이 없음"},render:({field:s})=>e(y,{...s,size:"small",error:!!z.name,InputProps:{style:{backgroundColor:"#fff",color:"#000"}}})}),e(g,{type:"submit",variant:"contained",size:"small",sx:{backgroundColor:"#000",color:"#fff"},children:e(d4,{})}),e(g,{variant:"contained",size:"small",onClick:()=>a(!1),children:e(c4,{})}),L||c&&e(Q,{size:"30px"})]})},"compTransition")})]})},m2=()=>{const{user:t}=O(),{data:C,isFetching:i}=r2(),a=d.useMemo(()=>t?.role==="ADMIN",[t]),r=d.useMemo(()=>i?"loader":"content",[i]);return e(j,{mode:"wait",children:e(N4,{children:i?e(Q,{size:"50px"}):n(A,{children:[a&&e(e4,{},"compAdd"),C?.map(c=>e(e4,{compData:c},c.id))]})},r)})},u2=t=>P4`
    display: flex;
